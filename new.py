...
# Create bullet
bullet = tk.PhotoImage(file="missile.png")
bullets = canvas.create_image(50,400, image=bullet)
...
#BINDING------------------------------------------------------------------------------
monster1x_bullet = canvas.coords(plane[0])
